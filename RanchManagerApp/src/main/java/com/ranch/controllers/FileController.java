...
//		
//		String fileDownloadUri = ServletUriComponentsBuilder.fromCurrentContextPath().path("/downloadFile/").path(String.valueOf(user.getId())).toUriString();
//	}
//	
//	@PostMapping("/uploadMultipleFiles")
//	public void uploadMultipleFiles(@RequestParam("files") MultipartFile[] files) {
//		Arrays.asList(files).stream().max((file,name) -> uploadFile(file,name)).collect(Collectors.toList());
//	}
//}
//
//
